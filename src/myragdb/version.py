...
_BUILD_DATE = datetime(2026, 1, 11)  # Update this when creating new releases
_MAJOR_VERSION = 2  # Increment for breaking changes
_MINOR_VERSION = 103  # Increment for new features (backward compatible)
_PATCH_VERSION = 4  # Increment for bug fixes only
